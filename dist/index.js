...
var fs = __nccwpck_require__(7147);
var path = __nccwpck_require__(1017);
var DOMException = __nccwpck_require__(7760);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await Promise.resolve().then(function () { return __nccwpck_require__(9127); });
...
__nccwpck_require__(7760);
var index = __nccwpck_require__(8735);
